...
Onboarding now optionally verifies unmatched character names against the Battle.net Game Data API (configured per-guild on the Discord onboarding roles admin page):
